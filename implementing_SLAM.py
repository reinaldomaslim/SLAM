...
def slam(data, N, num_landmarks, motion_noise, measurement_noise):
    ...
    omega=matrix()
    omega.zero(2*(N+num_landmarks),0)
    ...
    xi.value[0]=[world_size/2]
    xi.value[1]=[world_size/2]
    ...
    for i in range(len(data)):
        ...
        omega.value[2*i][2*i+2]-=1
        omega.value[2*i+2][2*i]-=1
        omega.value[2*i+2][2*i+2]+=1
        
        xi.value[2*i][0]-=data[i][1][0]
        xi.value[2*i+2][0]+=data[i][1][0]

        omega.value[2*i+1][2*i+1]+=1
        omega.value[2*i+1][2*i+3]-=1
        omega.value[2*i+3][2*i+1]-=1
        omega.value[2*i+3][2*i+3]+=1
        
        
        xi.value[2*i+1][0]-=move[1]
        xi.value[2*i+3][0]+=move[1]
        
        for j in range(len(landmarks)):
            landmark_no=landmarks[j][0]
            m=2*(N+landmark_no)
            ...
            xi.value[2*i][0]-=landmarks[j][1]
            xi.value[m][0]+=landmarks[j][1]

            omega.value[2*i+1][2*i+1]+=1
            omega.value[2*i+1][m+1]-=1
            omega.value[m+1][2*i+1]-=1
            omega.value[m+1][m+1]+=1
        
            xi.value[2*i+1][0]-=landmarks[j][2]
            xi.value[m+1][0]+=landmarks[j][2]
